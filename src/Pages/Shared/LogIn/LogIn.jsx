...
//                 type="password"
//                 id="confirmPassword"
//                 className={`form-input mt-1 text-black block w-full ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
...
//               </label>
//               {errors.terms && <span className="text-red-500 text-sm">You must agree to the terms and conditions</span>}
//             </div>
...
//             <hr className="w-2/5" />
//             <span className="mx-2 text-gray-500">login with</span>
//             <hr className="w-2/5" />
//           </div>
...
//             >
//             <p className='flex'> <FaFacebook/> Sign in with Facebook</p>
//             </button>
//             <button
//               type="button"
...
//             >
//              <p className='flex'><FaGoogle/> Sign in with Google</p>
//             </button>
//           </div>
//         </div>
//       </div>
